...
class Poseidon2Koalabear16Test(absltest.TestCase):
    ...
    def test_permute_emits_poseidon2_named_composite(self) -> None:
        ...
        # not a 6th operand, and any closed-over constant must stay inline in the
        # decomposition (frx#218) rather than surface as a leading operand — the
        # e2e GPU failure this guards.
    ...
    def test_non_identity_j_scale_stays_five_operands_canonical(self) -> None:
        ...
        # still emit exactly 5 operands (never a 6th operand).
