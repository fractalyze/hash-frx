...
class PoseidonMarkerEmissionTest(absltest.TestCase):
    def test_permute_emits_poseidon_named_composite(self) -> None:
        ...
        # Exactly the 2 ABI operands [state, round_constants flattened]. The
        # closed-over MDS must stay inline in the decomposition (frx#218), never
        # a leading operand of the 2-operand Poseidon emitter ABI.
