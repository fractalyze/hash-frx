...
canonical integer (decoding the Montgomery storage, with no frx x64 mode
needed). Every device -> oracle handoff in this package goes through these
two helpers so that subtlety is spelled once.
"""
