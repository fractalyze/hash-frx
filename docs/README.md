...
`hash_frx.digest.{sha256, sha512, field_sponge, keccak_sponge, blake3, grostl256, ascon_hash256, ripemd160, blake2b, blake2s}`
...
`hash_frx.digest.blake2b` and `hash_frx.digest.blake2s` are emitted
