...
| BLAKE3 — the 32-byte `ByteHash`, and the compression function its tree, keyed and extendable-output modes all share | [`blake3/`](../hash_frx/blake3), [`blake3/byte_hashes.py`](../hash_frx/blake3/byte_hashes.py) |
