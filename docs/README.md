...
| BLAKE3 — a `ByteHash` at any output length, and the compression function its tree and keyed modes share | [`blake3/`](../hash_frx/blake3), [`blake3/byte_hashes.py`](../hash_frx/blake3/byte_hashes.py) |
